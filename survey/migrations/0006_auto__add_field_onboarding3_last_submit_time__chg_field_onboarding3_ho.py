...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Onboarding3.last_submit_time'
        db.add_column(u'survey_onboarding3', 'last_submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Onboarding3.how_program'
        db.alter_column(u'survey_onboarding3', 'how_program', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Onboarding3.maintain_weight'
        db.alter_column(u'survey_onboarding3', 'maintain_weight', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Onboarding3.past_diet_program'
        db.alter_column(u'survey_onboarding3', 'past_diet_program', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'Onboarding1.last_submit_time'
        db.add_column(u'survey_onboarding1', 'last_submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Preliminary4.last_submit_time'
        db.add_column(u'survey_preliminary4', 'last_submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Preliminary3.last_submit_time'
        db.add_column(u'survey_preliminary3', 'last_submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Preliminary2.last_submit_time'
        db.add_column(u'survey_preliminary2', 'last_submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Preliminary1.last_submit_time'
        db.add_column(u'survey_preliminary1', 'last_submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Onboarding4.last_submit_time'
        db.add_column(u'survey_onboarding4', 'last_submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Onboarding4.my_net_diary'
        db.alter_column(u'survey_onboarding4', 'my_net_diary', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Onboarding4.aria_scale'
        db.alter_column(u'survey_onboarding4', 'aria_scale', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Onboarding4.fitbit'
        db.alter_column(u'survey_onboarding4', 'fitbit', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'Onboarding2.last_submit_time'
        db.add_column(u'survey_onboarding2', 'last_submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Onboarding3.last_submit_time'
        db.delete_column(u'survey_onboarding3', 'last_submit_time')


        # Changing field 'Onboarding3.how_program'
        db.alter_column(u'survey_onboarding3', 'how_program', self.gf('django.db.models.fields.TextField')(default=0))

        # Changing field 'Onboarding3.maintain_weight'
        db.alter_column(u'survey_onboarding3', 'maintain_weight', self.gf('django.db.models.fields.TextField')(default=0))

        # Changing field 'Onboarding3.past_diet_program'
        db.alter_column(u'survey_onboarding3', 'past_diet_program', self.gf('django.db.models.fields.TextField')(default=0))
        # Deleting field 'Onboarding1.last_submit_time'
        db.delete_column(u'survey_onboarding1', 'last_submit_time')

        # Deleting field 'Preliminary4.last_submit_time'
        db.delete_column(u'survey_preliminary4', 'last_submit_time')

        # Deleting field 'Preliminary3.last_submit_time'
        db.delete_column(u'survey_preliminary3', 'last_submit_time')

        # Deleting field 'Preliminary2.last_submit_time'
        db.delete_column(u'survey_preliminary2', 'last_submit_time')

        # Deleting field 'Preliminary1.last_submit_time'
        db.delete_column(u'survey_preliminary1', 'last_submit_time')

        # Deleting field 'Onboarding4.last_submit_time'
        db.delete_column(u'survey_onboarding4', 'last_submit_time')


        # Changing field 'Onboarding4.my_net_diary'
        db.alter_column(u'survey_onboarding4', 'my_net_diary', self.gf('django.db.models.fields.TextField')(default=0))

        # Changing field 'Onboarding4.aria_scale'
        db.alter_column(u'survey_onboarding4', 'aria_scale', self.gf('django.db.models.fields.TextField')(default=0))

        # Changing field 'Onboarding4.fitbit'
        db.alter_column(u'survey_onboarding4', 'fitbit', self.gf('django.db.models.fields.TextField')(default=0))
        # Deleting field 'Onboarding2.last_submit_time'
        db.delete_column(u'survey_onboarding2', 'last_submit_time')
